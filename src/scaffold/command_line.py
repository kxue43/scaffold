...
def main() -> None:
    parser = argparse.ArgumentParser(description="Scaffold a project with src layout.")
    parser.add_argument(
        "-r",
        "--root",
        type=Path,
    ...
    parser.add_argument(
        "--setup-cfg",
        action="store_true",
        help="Create setup.cfg template.",
    )
    ...
    def touch_file(target_name: str, target_dir: Optional[Path] = None) -> None:
